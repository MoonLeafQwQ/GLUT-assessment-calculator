...
import { actions as artActions } from "../../reducers/art.js";
import {
...
class ArtControl extends React.Component {
  ...
  render() {
    ...
    const part = scoreArt(art, this.props.rules || {});
    return (
...
function mapDispatchToProps(dispatch) {
  return {
    change_item: bindActionCreators((sign, index, field, value) =>
      sign === "adds"
        ? artActions.change_add(index, field, value)
        : artActions.change_minus(index, field, value), dispatch),
    add_row: bindActionCreators(artActions.add_row, dispatch),
    remove_row: bindActionCreators(artActions.remove_row, dispatch),
    change_editing: bindActionCreators(rootActions.change_editing, dispatch),
  };
}

export default connect(mapStateToProps, mapDispatchToProps)(ArtControl);
